...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('totalutilisateur')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">
              <span class="material-symbols-outlined">
              person
        ...
        <li class="nav-item">
          <a class="nav-link text-white text-white text-white active bg-gradient-primary" href="{{route('listcommend')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">
              <span class="material-symbols-outlined">
              add_business
    ...
    <div class="container-fluid py-4">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Table des Commandes</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1"> Touts  </span> Les commandes
                  </p>
                </div>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Image produit</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nom client</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nom prduit</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">prix</th>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">nom societe </th>
                  ...
                  @foreach($commadmins as $commadmin)
                    <tr >
                     <td >
                     <img src="/uploads/{{$commadmin->image_produit}}" width="100px"  class="avatar avatar-sm me-3 border-radius-lg" alt="user1">

                      </td>
                     <td>{{$commadmin->nom_user}}</td>
                     <td align="center">{{$commadmin->nom_prduit}}</td>
                     <td align="center">{{$commadmin->prix_total}} TND</td>
                     <td align="center" >
                    {{$commadmin->nom_soc}}
                    </td>
                     <td align="center">
                     <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="refusecommande/{{$commadmin->id}}"><i class="material-icons text-sm me-2">delete</i>Refuser</a>
                     <!-- <a class="btn btn-link text-success px-3 mb-0" href="validproducts/$record->id"> -->
                    
                    
                      <a class="btn btn-link text-success px-3 mb-0" href="acceptecommande/{{$commadmin->id}}"> <i class="material-icons text-sm me-2">
                      done</i>Valider</a>
      ...
      <div class="card">
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h6>Table des Commandes Refusés</h6>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1"> Les commandes </span> refusés 
                  </p>
                </div>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                  @foreach($blockcomm as $blockcomms)
                    <tr >
                     <td >
                     <img src="/uploads/{{$commadmin->image_produit}}" width="100px"  class="avatar avatar-sm me-3 border-radius-lg" alt="user1">

                      </td>
                     <td>{{$blockcomms->nom_user}}</td>
                     <td align="center">{{$blockcomms->nom_prduit}}</td>
                     <td align="center">{{$blockcomms->prix_total}} TND</td>
                     <td align="center" >
                    {{$blockcomms->nom_soc}}
                    </td>
