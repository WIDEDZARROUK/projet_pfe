...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white text-white text-white active bg-gradient-primary " href="{{url('/profilesl')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Profile de sociéte de livraison</li>
          </ol>
                     ...
                     <div class="col-md-5 pr-1">
                       ...
                       <label for="nomsociete">nom de société</label>
                         <input type="text" class="form-control" id ="nomsociete" 
                          name="nomsociete"  value="{{Auth::user()->nomsociete}}" >
                       </div>
                     </div>
                ...
                <img id="previewImg" alt="profile image" src="../assets/img/addc.png" style="max-width:100px;margin-top:20px;" />
                   ...
                   <div class="row">
                     <div class="update ml-auto mr-auto">
                       <button type="submit" class="btn btn-primary btn-round">Mise a jour</button>
                     </div>
                   </div>
                 </form>
              </div>
