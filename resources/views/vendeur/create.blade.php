			  ...
			  <div class="card mt-4">
				<div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
				  <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
					<h2 class="text-white text-capitalize ps-3"  align="center">Ajouter produit</h2>
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
             @csrf
              ...
              <input type="text" name="prix" class="form-control"  value="{{ old('prix') }}">
                ...
                <input type="text" name="solde" class="form-control"  value="{{ old('solde') }}">
                ...
                <input type="text" name="id_user" value="{{ Auth::user()->id }}" hidden>
                    ...
                    <a href="{{route('products.index')}}"  class="btn btn-danger" >Retour</a>
