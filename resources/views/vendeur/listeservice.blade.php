          ...
          <header class="header_area">
            ...
            @endif
                       <div class="help-line">
                          ...
                          <input name="query" id="query" value="{{ request()->input('query')}}" class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Chercher" aria-label="Search" >
                         </form>
                            </div>
                            </div>
                        </div>
    ...
    @endif
        <section class="shop_grid_area section_padding_100">
            <div class="container">
                ...
                <!-- <strike><P class="price" name="prix">prix TND</P></strike> -->
                           <p class="text-danger">{{ $record->nom }}</p>
                           <p>{{$record->desc}}</p>
                            <h4 class="product-price">{{ $record->prix }} TND</h4>
                           
                           
                           
                           <button type="button" class="btn btn-secondary">
                            <i class="fa fa-phone" aria-hidden="true"></i> {{ $record->phone }}
                          </button>
                        </div>
                    </div>
                    @endforeach
