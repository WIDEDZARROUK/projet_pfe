...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active  bg-gradient-primary " href="{{url('/profile')}}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="row gx-4 mb-2">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="/uploads/{{Auth::user()->imagevendeur}}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
            ...
            <div class="col-12 col-xl-4">
              <div class="card card-plain h-100">
                <div class="card-header pb-0 p-3">
                  <h6 class="mb-0">Informations sur le profil</h6>
                </div>
                <br>
                ...
                <form action="{{route('acc.update')}}" method="POST">
                   ...
                   <div class="row">
                     <div class="col-md-5 pr-1">
                       ...
                       <label for="nomsociete">nom de société </label>
                         <input type="text" class="form-control"  id ="nomsociete"  name="nomsociete"
                           value="{{Auth::user()->nomsociete}}" >
                        </div>
                     </div>
                   ...
                   <div class="row">
                     <div class="col-md-6 pr-1">
                       <div class="form-group">
                       <label for="numerosiret"> numéro de série de la sociétéde </label>
                         <input type="text" class="form-control" 
                          id="numerosiret" name="numerosiret" value="{{Auth::user()->numerosiret}}">
                       </div>
                     </div>
                     
                     <div class="col-md-6 pl-1">
                       <div class="form-group">
                       <label for="numerocart">numéro de carte</label>
                         <input type="text" class="form-control" id="numerocart" name="numerocart" 
                         value="{{Auth::user()->numerocart}}">
                       </div>
                     </div>
                   </div>
                   <br>
                   ...
                   <div class="col-md-6 pr-1">
            <div class="form-group">
            <label for="password">Mot de passe (désactivé)</label>
             <input type="text" class="form-control" disabled="" id="password" name="password" value="********">
               </div>
               <label for="description">À propos de Sociéte </label>
                         <textarea class="form-control textarea" id="description"
                          name="description" value="{{Auth::user()->description}}"></textarea>
                       
            </div>
        </div>
                   <br>
                   
                   <label for="imagevendeur">Image</label>
                <input type="file" name="imagevendeur" class="form-control" onchange="previewFile(this)">
                <img id="previewImg" alt="profile image" src="../assets/img/addc.png" style="max-width:100px;margin-top:20px;" />
                   ...
                   <div class="row">
                     <div class="update ml-auto mr-auto">
                       <button type="submit" class="btn btn-primary btn-round">Mise a jours Profile</button>
                     </div>
                   </div>
                 </form>
              </div>
