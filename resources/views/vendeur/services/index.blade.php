    ...
    <table class="table align-items-center mb-0">
        ...
        <tr>
            ...
            <td>
                ...
                <a type="submit" class="servideletebtn" data-id="{{$record->id}}">
                  <img src="../assets/img/delete.png" height ="20" width="20" /></a>
...
.then((willDelete) => {
  if (willDelete) {
    window.location="/deleteservice/"+pegawaiid+""
    swal("Votre service a été supprimé!", {
      icon: "success",
    });
  } else {
    swal("Votre service est en sécurité !");
  }
});
            });
});
