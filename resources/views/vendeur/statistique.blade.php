...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white text-white active  bg-gradient-primary " href="{{ url('/dashboard') }}">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Vendeur</li>
          </ol>
      ...
      <div class="card z-index-2  ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="border-radius-lg py-3 pe-1">
                ...
                <iframe src="{{url('/charts6')}}" style="width:100%" frameborder="0" scrolling="no" onload="resizeIframe(this)"> 
              </iframe>
              <script>
            ...
            <div class="card-body">
              <h6 class="mb-0 ">Nombre des Commentaires :</h6><br>
              <p class="text-sm "> <span class="font-weight-bolder">* </span> Cet histogramme pour les nombres des Commentaire
              par produit  .</p>
            </div>
          </div>
    </div>
    ...
    <div class="card z-index-2 ">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class=" border-radius-lg py-3 pe-1">
                <div class="chart">
                <br>
                <iframe src="{{url('/charts7')}}" style="width:100%" frameborder="0" scrolling="no" onload="resizeIframe(this)"> </iframe>
                <script>
                function resizeIframe(obj) {
                  obj.style.height = obj.contentWindow.document.documentElement.scrollHeight + 'px';
                }
            ...
            <div class="card-body">
              ...
              <h6 class="mb-0 ">Nombre des produit par produit commende :</h6><br>
              <p class="text-sm "> <span class="font-weight-bolder">* </span> Cet histogramme pour lesnombres
               des produit par produit commende .</p>
          ...
          <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="http://127.0.0.1:8000/" class="nav-link text-muted" target="_blank">Acueil</a>
                </li>
                <li class="nav-item">
