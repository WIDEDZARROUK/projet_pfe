...
Route::get('/deleteservice/{id}', [ServiceCtrl::class,'destroy'])->name('deleteservice');
...
Route::get('/noconfirmedproducts',[ProductCtrl::class, 'total'])->name('noconfirmedproducts');

Route::get('/totalutilisateur',[ProductCtrl::class, 'totalutilisateur'])->name('totalutilisateur');
Route::get('/novaliduser/{id}', [ProductCtrl::class, 'novaliduser'])->name('novaliduser');
Route::get('/validuser/{id}', [ProductCtrl::class, 'validuser'])->name('validuser');
...
Route::post('/affecterlivreur', [LivreurCtrl::class, 'affecterlivreur'])->name('affecterlivreur');
...
// Route::get ( '/dashboard' ,'App\Http\Controllers\DashboardController@statistics')->name('dashboard');
 ...
 Route::get('/charts5', [ChartController::class,'indexslivreurs'])->name('charts5');
 Route::get('/charts6', [ChartController::class,'indexspostvendeur'])->name('charts6');
 Route::get('/charts7', [ChartController::class,'indexsnomprodvendor'])->name('charts7');
